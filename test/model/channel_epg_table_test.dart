...
void main() {
  group('XTremeCodeChannelEpgTable', () {
    test('fromJson should parse json correctly', () {
      ...
      var table = XTremeCodeChannelEpgTable.fromJson(mockJsonString);
      var listing = table.epgListings[0];
      ...
      table = XTremeCodeChannelEpgTable.fromJson(mockJsonInt);
      listing = table.epgListings[0];
      expect(listing.id, 67843793);
      expect(listing.epgId, 35);
      expect(listing.title, 'VGFnZXNzY2hhdQ==');
      expect(listing.lang, '');
